...
class Hero {
    ...
    colision(enemy){
        return(this.heroX < enemy.x + enemy.width && this.heroY < enemy.y + enemy.height && this.heroX + this.width > enemy.x && this.heroY + this.height > enemy.y) 
    }
}
...
function gameOver(){
    ...
    requestId = undefined
    ctx.fillStyle = "red";
    ctx.fillText("GAME OVER ",canvas.width / 2 - 200,500)
}
